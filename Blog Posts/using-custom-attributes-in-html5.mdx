 ...
 **Note: I recommend you do this after the declaration of the variables as it 
 ...
 So using that piece of code, we told the browser, "Anytime the page loads, 
 pass the event handler for the click event to the button". IAlso, I used an arrow function in that block of code. If you aren't familiar with arrow functions, you can read up about them  [here](https://www.w3schools.com/js/js_arrow_function.asp).
